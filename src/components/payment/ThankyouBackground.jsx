  ...
  return (
    <div className="min-h-screen bg-white flex flex-col" style={{ fontFamily: "'Segoe UI', Arial, sans-serif" }}>
      ...
      <div className="flex flex-col items-center justify-center flex-1 px-4 py-16">
        {/* Score section — number hidden */}
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold text-[#0C3547] mb-3">
            {t("yourIQScoreIs")}
          </h1>
          {/* Blurred placeholder instead of real score */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl">
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 flex flex-col items-center text-center shadow-sm">
            ...
            <div className="w-full bg-[#F5921B] text-white font-bold py-3 rounded-lg text-sm flex items-center justify-center gap-2 opacity-60">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 flex flex-col items-center text-center shadow-sm">
            ...
            <div className="w-full bg-[#0C3547] text-white font-bold py-3 rounded-lg text-sm flex items-center justify-center gap-2 opacity-60">
              {t("viewReport")}
            </div>
          </div>
        </div>
