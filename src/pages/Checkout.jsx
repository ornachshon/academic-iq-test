    ...
    <div className="min-h-screen bg-gray-100 text-sm text-gray-800">
      ...
      <div className="text-center py-5 px-4 bg-white border-b border-gray-200">
        ...
        <p className="text-gray-700 font-medium mt-1">
          Get your results, a printable IQ certificate, and a 7-day trial of the IQ Booster plan for <strong>$4.99</strong>. Then <strong>$29.99 every 28 days</strong>.
        </p>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-4">
        ...
        <div className="bg-white border border-gray-200 rounded-sm divide-y divide-gray-200">
          ...
          <div className="flex items-center justify-between px-5 py-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-bold text-gray-800">IQ Booster Program</p>
                <p className="text-gray-500 text-xs mt-0.5">7-day trial to IQ Booster – a personalized brain training program tailored specifically to you.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-sm px-5 py-5 space-y-4">
          ...
          {/* CTA Button */}
          <button
            className="w-full bg-[#F5921B] hover:bg-[#e0830f] text-white font-extrabold text-base py-3 rounded-md transition-colors"
          >
            Continue to Payment
          </button>
        </div>
        ...
        <p className="text-xs text-gray-500 text-center px-2 pb-2">
          By clicking "Continue to Payment" you agree to pay $4.99 for your results, and 7 days access to IQ Booster - brain training platform. Also you accept our Terms of Use, Privacy Policy and subscription policy. After 7 days, your subscription will begin automatically and renew at $29.99 every 4 weeks until canceled. You may cancel anytime via your IQ Booster dashboard or by contacting us at{' '}
          <a href="mailto:info@iqbooster.org" className="underline">info@iqbooster.org</a>.
        </p>
