        ...
        <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm p-6 relative z-10">
          ...
          {payMethod === "oneclick" && (
            <>
              ...
              {/* Google Pay */}
              <button onClick={() => goToInfo("google_pay")} className="w-full mb-2 bg-black text-white rounded-lg py-3 flex items-center justify-center gap-2 hover:bg-gray-900 transition-colors font-medium text-sm">
              ...
              {/* PayPal */}
              <button onClick={() => goToInfo("paypal")} className="w-full mb-2 bg-[#FFC439] rounded-lg py-3 flex items-center justify-center hover:bg-[#f0b429] transition-colors">
          ...
          {payMethod === "card" && (
            <div className="mt-3 space-y-2">
              ...
              <button onClick={() => goToInfo("credit_card")} className="w-full bg-[#1a56db] hover:bg-[#1648c7] text-white font-bold py-3 rounded-lg text-sm transition-colors">
                Get My IQ Result
              </button>
            </div>
          )}
