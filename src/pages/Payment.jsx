    ...
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center px-4">
        <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm p-6 relative z-10">
          ...
          {/* One-click payment label */}
          <div className="flex items-center gap-2 mb-2">
            <div className="w-4 h-4 rounded-full border-2 border-[#0C3547] flex items-center justify-center flex-shrink-0">
              <div className="w-2 h-2 rounded-full bg-[#0C3547]" />
            </div>
          ...
          {/* PayPal */}
          <button className="w-full mb-4 bg-[#FFC439] rounded-lg py-3 flex items-center justify-center hover:bg-[#f0b429] transition-colors">
          ...
          {/* Credit card row */}
          <div className="flex items-center justify-between border border-gray-200 rounded-lg px-4 py-3 mb-5 cursor-pointer hover:border-[#F5921B] transition-colors">
