...
export default function Payment() {
  ...
  const [payMethod, setPayMethod] = useState("oneclick");
  ...
  return (
    <div className="min-h-screen bg-gray-50" style={{ fontFamily: "'Segoe UI', Arial, sans-serif" }}>
      ...
      {/* Top banner */}
      <div className="bg-[#0C3547] text-white text-center py-5 px-4">
        <p className="text-lg md:text-xl">
          Your IQ test is complete! Unlock your full results for only <strong>$4.99</strong>
        </p>
        <p className="text-sm text-blue-200 mt-1">Get your personalized IQ score, certificate, and detailed analysis</p>
      </div>

      <div className="max-w-5xl mx-auto px-4 py-8">

        {/* ORDER DETAILS header */}
        <div className="bg-[#F5921B] text-white text-center font-black text-lg tracking-widest py-4 rounded-t-lg uppercase">
          Order Details
        </div>

        {/* Order items */}
        <div className="border border-gray-200 rounded-b-lg overflow-hidden mb-8 bg-white">

          {/* Item 1 */}
          <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
            <div className="flex items-start gap-5">
              <span className="text-[#0C3547] font-black text-2xl w-8 shrink-0">1.</span>
              <div>
            ...
            <div className="flex items-center gap-3 shrink-0">
              <div className="text-right">
                <p className="text-xs font-bold text-[#0C3547] tracking-widest uppercase">Your</p>
                <p className="text-xs font-bold text-[#0C3547] tracking-widest uppercase">IQ Score</p>
              </div>
              <div className="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center text-gray-400 font-bold text-xl border-2 border-gray-300">
                ?
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
            <div className="flex items-start gap-5">
              <span className="text-[#0C3547] font-black text-2xl w-8 shrink-0">2.</span>
              <div>
                <p className="font-bold text-[#0C3547] text-lg">Printable World Wide IQ Certificate</p>
                <p className="text-gray-500 text-sm mt-0.5">Your very own World Wide IQ Certificate</p>
                <p className="text-gray-400 text-sm italic">(High Quality Downloadable PDF)</p>
              </div>
            </div>
            <div className="shrink-0 ml-4">
              <img
                src="https://media.base44.com/images/public/69b1aedc5a0abb358cd40ec0/cabd54a8b_image.png"
                alt="IQ Certificate"
                className="w-28 h-20 object-cover rounded border border-gray-200 shadow-sm"
              />
            </div>
          </div>
          ...
          <div className="flex items-center justify-between px-6 py-5">
            <div className="flex items-start gap-5">
              <span className="text-[#0C3547] font-black text-2xl w-8 shrink-0">3.</span>
              <div>
                <p className="font-bold text-[#0C3547] text-lg">Detailed IQ Analysis Report</p>
                <p className="text-gray-500 text-sm mt-0.5">In-depth breakdown of your cognitive strengths</p>
                <p className="text-gray-400 text-sm italic">(High Quality Downloadable PDF)</p>
              </div>
            </div>
            <div className="shrink-0 ml-4 w-28 h-20 bg-gray-100 rounded border border-gray-200 flex items-center justify-center text-gray-300 text-xs">
              Report
            </div>
          </div>
        </div>

        {/* Two-column: summary + payment */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">

          {/* Left: price summary */}
          <div className="bg-white border border-gray-200 rounded-xl p-6 flex flex-col justify-between">
            <div>
              <h3 className="font-bold text-[#0C3547] text-lg mb-4">Order Summary</h3>
              <div className="flex justify-between text-sm text-gray-600 mb-2">
                <span>IQ Results Package</span>
                <span>$4.99</span>
              </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            <h3 className="font-bold text-[#0C3547] text-lg mb-4">Payment Method</h3>
            ...
            >
              <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center shrink-0 ${payMethod === "oneclick" ? "border-[#0C3547]" : "border-gray-300"}`}>
            ...
            >
              <div className="flex items-center gap-2">
                <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center shrink-0 ${payMethod === "card" ? "border-[#0C3547]" : "border-gray-300"}`}>
            ...
            {payMethod === "card" && (
              <div className="mt-3 space-y-2">
                ...
                <button onClick={() => goToCheckout("credit_card")} disabled={loading}
                  className="w-full bg-[#F5921B] hover:bg-[#e0830f] text-white font-bold py-3 rounded-lg text-sm transition-colors disabled:opacity-60">
                  Get My IQ Result
                </button>
              </div>
            )}
